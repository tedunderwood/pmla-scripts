...
Metadata <- read.table('/Users/tunderwood/Dropbox/PMLA/metadata/MergedMetadata.CSV', header = FALSE, stringsAsFactors=FALSE, sep = '\t', fill = TRUE, nrows = 10000, quote = '"')
myIDs <- as.character(Metadata$V1)
names(myIDs) <- as.character(Metadata$V2)
